...
// checks if the ResponseListWAFRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListWAFRule{}

// ResponseListWAFRule struct for ResponseListWAFRule
type ResponseListWAFRule struct {
	Id int32 `json:"id"`
...
type _ResponseListWAFRule ResponseListWAFRule
...
func (o *ResponseListWAFRule) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o ResponseListWAFRule) MarshalJSON() ([]byte, error) {
...
func (o ResponseListWAFRule) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseListWAFRule) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseListWAFRule := _ResponseListWAFRule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseListWAFRule)

	if err != nil {
		return err
	}

	*o = ResponseListWAFRule(varResponseListWAFRule)

	return err
}

type NullableResponseListWAFRule struct {
	value *ResponseListWAFRule
	isSet bool
}

func (v NullableResponseListWAFRule) Get() *ResponseListWAFRule {
	return v.value
}

func (v *NullableResponseListWAFRule) Set(val *ResponseListWAFRule) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListWAFRule) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListWAFRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListWAFRule(val *ResponseListWAFRule) *NullableResponseListWAFRule {
	return &NullableResponseListWAFRule{value: val, isSet: true}
}

func (v NullableResponseListWAFRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListWAFRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
