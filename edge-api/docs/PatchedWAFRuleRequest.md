...
`func (o *PatchedWAFRuleRequest) GetRuleId() int32`

GetRuleId returns the RuleId field if non-nil, zero value otherwise.

### GetRuleIdOk

`func (o *PatchedWAFRuleRequest) GetRuleIdOk() (*int32, bool)`
...
`func (o *PatchedWAFRuleRequest) SetRuleId(v int32)`
...
`func (o *PatchedWAFRuleRequest) GetMatchZones() []MatchZoneRequest`

GetMatchZones returns the MatchZones field if non-nil, zero value otherwise.

### GetMatchZonesOk

`func (o *PatchedWAFRuleRequest) GetMatchZonesOk() (*[]MatchZoneRequest, bool)`
...
`func (o *PatchedWAFRuleRequest) SetMatchZones(v []MatchZoneRequest)`

SetMatchZones sets MatchZones field to given value.

### HasMatchZones

`func (o *PatchedWAFRuleRequest) HasMatchZones() bool`

HasMatchZones returns a boolean if a field has been set.

### GetUseRegex

`func (o *PatchedWAFRuleRequest) GetUseRegex() bool`

GetUseRegex returns the UseRegex field if non-nil, zero value otherwise.

### GetUseRegexOk

`func (o *PatchedWAFRuleRequest) GetUseRegexOk() (*bool, bool)`
...
`func (o *PatchedWAFRuleRequest) SetUseRegex(v bool)`

SetUseRegex sets UseRegex field to given value.

### HasUseRegex

`func (o *PatchedWAFRuleRequest) HasUseRegex() bool`
