...
func main() {
	edgeApplicationId := "edgeApplicationId_example" // string | 
	id := "id_example" // string | 
	errorResponsesRequest := *openapiclient.NewErrorResponsesRequest([]openapiclient.NestedErrorResponseRequest{*openapiclient.NewNestedErrorResponseRequest(int64(123), int32(123))}) // ErrorResponsesRequest | 
