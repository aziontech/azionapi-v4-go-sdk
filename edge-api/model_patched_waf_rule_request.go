...
type PatchedWAFRuleRequest struct {
	...
	MatchZones []MatchZoneRequest `json:"match_zones,omitempty"`
...
// SetMatchZones gets a reference to the given []MatchZoneRequest and assigns it to the MatchZones field.
