...
func (a *EdgeApplicationsCacheSettingsAPIService) CreateCacheSettingExecute(r ApiCreateCacheSettingRequest) (*ResponseCacheSetting, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/edge_application/applications/{edgeApplicationId}/cache_settings"
...
func (r ApiDestroyCacheSettingRequest) Execute() (*ResponseDeleteCacheSetting, *http.Response, error) {
...
func (a *EdgeApplicationsCacheSettingsAPIService) DestroyCacheSettingExecute(r ApiDestroyCacheSettingRequest) (*ResponseDeleteCacheSetting, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/edge_application/applications/{edgeApplicationId}/cache_settings/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"edgeApplicationId"+"}", url.PathEscape(parameterValueToString(r.edgeApplicationId, "edgeApplicationId")), -1)
...
// Execute executes the request
//  @return ResponseCacheSetting
func (a *EdgeApplicationsCacheSettingsAPIService) PartialUpdateCacheSettingExecute(r ApiPartialUpdateCacheSettingRequest) (*ResponseCacheSetting, *http.Response, error) {
	var (
...
// Execute executes the request
//  @return ResponseCacheSetting
func (a *EdgeApplicationsCacheSettingsAPIService) UpdateCacheSettingExecute(r ApiUpdateCacheSettingRequest) (*ResponseCacheSetting, *http.Response, error) {
	var (
