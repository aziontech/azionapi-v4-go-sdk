...
// checks if the ResponseBadRequestEdgeApplicationFunctionInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseBadRequestEdgeApplicationFunctionInstance{}

// ResponseBadRequestEdgeApplicationFunctionInstance struct for ResponseBadRequestEdgeApplicationFunctionInstance
type ResponseBadRequestEdgeApplicationFunctionInstance struct {
...
func NewResponseBadRequestEdgeApplicationFunctionInstance() *ResponseBadRequestEdgeApplicationFunctionInstance {
	this := ResponseBadRequestEdgeApplicationFunctionInstance{}
	return &this
}
...
func (o ResponseBadRequestEdgeApplicationFunctionInstance) MarshalJSON() ([]byte, error) {
...
func (o ResponseBadRequestEdgeApplicationFunctionInstance) ToMap() (map[string]interface{}, error) {
...
type NullableResponseBadRequestEdgeApplicationFunctionInstance struct {
	value *ResponseBadRequestEdgeApplicationFunctionInstance
	isSet bool
}

func (v NullableResponseBadRequestEdgeApplicationFunctionInstance) Get() *ResponseBadRequestEdgeApplicationFunctionInstance {
	return v.value
}

func (v *NullableResponseBadRequestEdgeApplicationFunctionInstance) Set(val *ResponseBadRequestEdgeApplicationFunctionInstance) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseBadRequestEdgeApplicationFunctionInstance) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseBadRequestEdgeApplicationFunctionInstance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseBadRequestEdgeApplicationFunctionInstance(val *ResponseBadRequestEdgeApplicationFunctionInstance) *NullableResponseBadRequestEdgeApplicationFunctionInstance {
	return &NullableResponseBadRequestEdgeApplicationFunctionInstance{value: val, isSet: true}
}

func (v NullableResponseBadRequestEdgeApplicationFunctionInstance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseBadRequestEdgeApplicationFunctionInstance) UnmarshalJSON(src []byte) error {
	v.isSet = true
