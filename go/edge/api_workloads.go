...
func (a *WorkloadsAPIService) CreateWorkloadExecute(r ApiCreateWorkloadRequest) (*ResponseWorkload, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ResponseBadRequestWorkload
...
func (r ApiDestroyWorkloadRequest) Execute() (*ResponseDeleteWorkload, *http.Response, error) {
...
func (a *WorkloadsAPIService) DestroyWorkloadExecute(r ApiDestroyWorkloadRequest) (*ResponseDeleteWorkload, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/workspace/workloads/{globalId}"
...
// Which field to use when ordering the results. (Valid fields: edge_application, edge_firewall, id, name, last_editor, last_modified, active, alternate_domains, network_map, domains, product_version)
...
func (r ApiListWorkloadsRequest) Execute() (*PaginatedResponseListWorkloadList, *http.Response, error) {
...
// Execute executes the request
//  @return PaginatedResponseListWorkloadList
func (a *WorkloadsAPIService) ListWorkloadsExecute(r ApiListWorkloadsRequest) (*PaginatedResponseListWorkloadList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedResponseListWorkloadList
	)
