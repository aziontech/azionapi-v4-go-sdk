...
// PatchedNetworkListRequest struct for PatchedNetworkListRequest
type PatchedNetworkListRequest struct {
	Name *string `json:"name,omitempty" validate:"regexp=.*"`
	Type *Type687Enum `json:"type,omitempty"`
...
// SetType gets a reference to the given Type687Enum and assigns it to the Type field.
