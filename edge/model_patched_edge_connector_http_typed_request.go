...
// checks if the PatchedEdgeConnectorHTTPTypedRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedEdgeConnectorHTTPTypedRequest{}

// PatchedEdgeConnectorHTTPTypedRequest struct for PatchedEdgeConnectorHTTPTypedRequest
type PatchedEdgeConnectorHTTPTypedRequest struct {
...
func NewPatchedEdgeConnectorHTTPTypedRequest() *PatchedEdgeConnectorHTTPTypedRequest {
	this := PatchedEdgeConnectorHTTPTypedRequest{}
	return &this
}
...
func (o PatchedEdgeConnectorHTTPTypedRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedEdgeConnectorHTTPTypedRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePatchedEdgeConnectorHTTPTypedRequest struct {
	value *PatchedEdgeConnectorHTTPTypedRequest
	isSet bool
}

func (v NullablePatchedEdgeConnectorHTTPTypedRequest) Get() *PatchedEdgeConnectorHTTPTypedRequest {
	return v.value
}

func (v *NullablePatchedEdgeConnectorHTTPTypedRequest) Set(val *PatchedEdgeConnectorHTTPTypedRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedEdgeConnectorHTTPTypedRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedEdgeConnectorHTTPTypedRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedEdgeConnectorHTTPTypedRequest(val *PatchedEdgeConnectorHTTPTypedRequest) *NullablePatchedEdgeConnectorHTTPTypedRequest {
	return &NullablePatchedEdgeConnectorHTTPTypedRequest{value: val, isSet: true}
}

func (v NullablePatchedEdgeConnectorHTTPTypedRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedEdgeConnectorHTTPTypedRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
