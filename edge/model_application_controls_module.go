...
type ApplicationControlsModule struct {
	CacheByQueryString CacheByQueryStringEnum `json:"cache_by_query_string"`
	QueryStringFields []string `json:"query_string_fields"`
	QueryStringSortEnabled bool `json:"query_string_sort_enabled"`
	CacheByCookies CacheByCookiesEnum `json:"cache_by_cookies"`
	CookieNames []string `json:"cookie_names"`
	AdaptiveDeliveryAction AdaptiveDeliveryActionEnum `json:"adaptive_delivery_action"`
...
func (o *ApplicationControlsModule) GetCacheByQueryString() CacheByQueryStringEnum {
	if o == nil {
		var ret CacheByQueryStringEnum
		return ret
	}
...
func (o *ApplicationControlsModule) GetAdaptiveDeliveryAction() AdaptiveDeliveryActionEnum {
	if o == nil {
		var ret AdaptiveDeliveryActionEnum
		return ret
	}
