...
type MTLS struct {
	Verification *VerificationEnum `json:"verification,omitempty"`
...
func NewMTLS() *MTLS {
	this := MTLS{}
	var verification VerificationEnum = enforce
...
// SetVerification gets a reference to the given VerificationEnum and assigns it to the Verification field.
