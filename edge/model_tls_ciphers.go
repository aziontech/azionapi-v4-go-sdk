...
func (dst *TLSCiphers) UnmarshalJSON(data []byte) error {
	var err error
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TLSCiphers)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TLSCiphers)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src TLSCiphers) MarshalJSON() ([]byte, error) {
...
func (obj *TLSCiphers) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj TLSCiphers) GetActualInstanceValue() (interface{}) {
	if obj.MapmapOfStringAny != nil {
		return *obj.MapmapOfStringAny
	}
...
type NullableTLSCiphers struct {
	value *TLSCiphers
	isSet bool
}

func (v NullableTLSCiphers) Get() *TLSCiphers {
	return v.value
}

func (v *NullableTLSCiphers) Set(val *TLSCiphers) {
	v.value = val
	v.isSet = true
}

func (v NullableTLSCiphers) IsSet() bool {
	return v.isSet
}

func (v *NullableTLSCiphers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTLSCiphers(val *TLSCiphers) *NullableTLSCiphers {
	return &NullableTLSCiphers{value: val, isSet: true}
}

func (v NullableTLSCiphers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTLSCiphers) UnmarshalJSON(src []byte) error {
	v.isSet = true
