...
func (r ApiCloneWAFRequest) Execute() (*ResponseRetrieveWAF, *http.Response, error) {
...
*/
func (a *WAFsAPIService) CloneWAF(ctx context.Context, id string) ApiCloneWAFRequest {
	return ApiCloneWAFRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *WAFsAPIService) CloneWAFExecute(r ApiCloneWAFRequest) (*ResponseRetrieveWAF, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/edge_firewall/wafs/{id}/clone"
...
*/
func (a *WAFsAPIService) DestroyWAF(ctx context.Context, id string) ApiDestroyWAFRequest {
	return ApiDestroyWAFRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *WAFsAPIService) DestroyWAFExecute(r ApiDestroyWAFRequest) (*ResponseDeleteWAF, *http.Response, error) {
	...
	localVarPath := localBasePath + "/edge_firewall/wafs/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiListWAFsRequest) Execute() (*PaginatedResponseListWAFList, *http.Response, error) {
...
// Execute executes the request
//  @return PaginatedResponseListWAFList
func (a *WAFsAPIService) ListWAFsExecute(r ApiListWAFsRequest) (*PaginatedResponseListWAFList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedResponseListWAFList
	)
...
*/
func (a *WAFsAPIService) PartialUpdateWAF(ctx context.Context, id string) ApiPartialUpdateWAFRequest {
	return ApiPartialUpdateWAFRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *WAFsAPIService) RetrieveWAF(ctx context.Context, id string) ApiRetrieveWAFRequest {
	return ApiRetrieveWAFRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *WAFsAPIService) UpdateWAF(ctx context.Context, id string) ApiUpdateWAFRequest {
	return ApiUpdateWAFRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
