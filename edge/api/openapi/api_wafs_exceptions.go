...
func (a *WAFsExceptionsAPIService) CreateWAFExceptionExecute(r ApiCreateWAFExceptionRequest) (*ResponseWAFRule, *http.Response, error) {
	...
	localVarPath := localBasePath + "/edge_firewall/wafs/{wafId}/exceptions"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ResponseBadRequestWAFRule
...
*/
func (a *WAFsExceptionsAPIService) DestroyWAFException(ctx context.Context, id string, wafId string) ApiDestroyWAFExceptionRequest {
	return ApiDestroyWAFExceptionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *WAFsExceptionsAPIService) DestroyWAFExceptionExecute(r ApiDestroyWAFExceptionRequest) (*ResponseDeleteWAFRule, *http.Response, error) {
	...
	localVarPath := localBasePath + "/edge_firewall/wafs/{wafId}/exceptions/{id}"
...
// Which field to use when ordering the results. (Valid fields: rule_id, name, path, match_zones, use_regex, active, last_editor, last_modified)
...
func (r ApiListWAFExceptionsRequest) Execute() (*PaginatedResponseListWAFRuleList, *http.Response, error) {
...
// Execute executes the request
//  @return PaginatedResponseListWAFRuleList
func (a *WAFsExceptionsAPIService) ListWAFExceptionsExecute(r ApiListWAFExceptionsRequest) (*PaginatedResponseListWAFRuleList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedResponseListWAFRuleList
	)
...
*/
func (a *WAFsExceptionsAPIService) PartialUpdateWAFException(ctx context.Context, id string, wafId string) ApiPartialUpdateWAFExceptionRequest {
	return ApiPartialUpdateWAFExceptionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *WAFsExceptionsAPIService) RetrieveWAFException(ctx context.Context, id string, wafId string) ApiRetrieveWAFExceptionRequest {
	return ApiRetrieveWAFExceptionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *WAFsExceptionsAPIService) UpdateWAFException(ctx context.Context, id string, wafId string) ApiUpdateWAFExceptionRequest {
	return ApiUpdateWAFExceptionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
