...
// checks if the EdgeConnectorS3TypedRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EdgeConnectorS3TypedRequest{}

// EdgeConnectorS3TypedRequest struct for EdgeConnectorS3TypedRequest
type EdgeConnectorS3TypedRequest struct {
...
type _EdgeConnectorS3TypedRequest EdgeConnectorS3TypedRequest
...
func NewEdgeConnectorS3TypedRequest(name string, modules EdgeConnectorModulesRequest, type_ string, typeProperties EdgeConnectorS3TypePropertiesRequest) *EdgeConnectorS3TypedRequest {
	this := EdgeConnectorS3TypedRequest{}
	this.Name = name
...
func (o EdgeConnectorS3TypedRequest) MarshalJSON() ([]byte, error) {
...
func (o EdgeConnectorS3TypedRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EdgeConnectorS3TypedRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEdgeConnectorS3TypedRequest := _EdgeConnectorS3TypedRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEdgeConnectorS3TypedRequest)

	if err != nil {
		return err
	}

	*o = EdgeConnectorS3TypedRequest(varEdgeConnectorS3TypedRequest)

	return err
}

type NullableEdgeConnectorS3TypedRequest struct {
	value *EdgeConnectorS3TypedRequest
	isSet bool
}

func (v NullableEdgeConnectorS3TypedRequest) Get() *EdgeConnectorS3TypedRequest {
	return v.value
}

func (v *NullableEdgeConnectorS3TypedRequest) Set(val *EdgeConnectorS3TypedRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEdgeConnectorS3TypedRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEdgeConnectorS3TypedRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEdgeConnectorS3TypedRequest(val *EdgeConnectorS3TypedRequest) *NullableEdgeConnectorS3TypedRequest {
	return &NullableEdgeConnectorS3TypedRequest{value: val, isSet: true}
}

func (v NullableEdgeConnectorS3TypedRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEdgeConnectorS3TypedRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
