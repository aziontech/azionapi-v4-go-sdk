...
`func (o *PatchedWorkloadRequest) GetNetworkMap() NetworkMapEnum`

GetNetworkMap returns the NetworkMap field if non-nil, zero value otherwise.

### GetNetworkMapOk

`func (o *PatchedWorkloadRequest) GetNetworkMapOk() (*NetworkMapEnum, bool)`
...
`func (o *PatchedWorkloadRequest) SetNetworkMap(v NetworkMapEnum)`
