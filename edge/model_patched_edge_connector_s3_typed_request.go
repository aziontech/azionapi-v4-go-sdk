...
// checks if the PatchedEdgeConnectorS3TypedRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedEdgeConnectorS3TypedRequest{}

// PatchedEdgeConnectorS3TypedRequest struct for PatchedEdgeConnectorS3TypedRequest
type PatchedEdgeConnectorS3TypedRequest struct {
...
func NewPatchedEdgeConnectorS3TypedRequest() *PatchedEdgeConnectorS3TypedRequest {
	this := PatchedEdgeConnectorS3TypedRequest{}
	return &this
}
...
func (o PatchedEdgeConnectorS3TypedRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedEdgeConnectorS3TypedRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePatchedEdgeConnectorS3TypedRequest struct {
	value *PatchedEdgeConnectorS3TypedRequest
	isSet bool
}

func (v NullablePatchedEdgeConnectorS3TypedRequest) Get() *PatchedEdgeConnectorS3TypedRequest {
	return v.value
}

func (v *NullablePatchedEdgeConnectorS3TypedRequest) Set(val *PatchedEdgeConnectorS3TypedRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedEdgeConnectorS3TypedRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedEdgeConnectorS3TypedRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedEdgeConnectorS3TypedRequest(val *PatchedEdgeConnectorS3TypedRequest) *NullablePatchedEdgeConnectorS3TypedRequest {
	return &NullablePatchedEdgeConnectorS3TypedRequest{value: val, isSet: true}
}

func (v NullablePatchedEdgeConnectorS3TypedRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedEdgeConnectorS3TypedRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
