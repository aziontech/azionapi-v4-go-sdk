...
func (a *CustomPagesAPIService) CreateCustomPageExecute(r ApiCreateCustomPageRequest) (*ResponseCustomPages, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ResponseBadRequestCustomPages
...
func (r ApiListCustomPagesRequest) Execute() (*PaginatedResponseListCustomPagesList, *http.Response, error) {
...
// Execute executes the request
//  @return PaginatedResponseListCustomPagesList
func (a *CustomPagesAPIService) ListCustomPagesExecute(r ApiListCustomPagesRequest) (*PaginatedResponseListCustomPagesList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedResponseListCustomPagesList
	)
