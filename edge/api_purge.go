...
func (a *PurgeAPIService) CreatePurgeRequestExecute(r ApiCreatePurgeRequestRequest) (*ResponsePurgeInput, *http.Response, error) {
	...
	localVarPath := localBasePath + "/workspace/purge/{purgeType}"
	localVarPath = strings.Replace(localVarPath, "{"+"purgeType"+"}", url.PathEscape(parameterValueToString(r.purgeType, "purgeType")), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ResponseBadRequestPurgeInput
