...
// checks if the DataStreamFilterRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataStreamFilterRequest{}

// DataStreamFilterRequest struct for DataStreamFilterRequest
type DataStreamFilterRequest struct {
...
func (o DataStreamFilterRequest) MarshalJSON() ([]byte, error) {
...
func (o DataStreamFilterRequest) ToMap() (map[string]interface{}, error) {
...
type NullableDataStreamFilterRequest struct {
	value *DataStreamFilterRequest
	isSet bool
}

func (v NullableDataStreamFilterRequest) Get() *DataStreamFilterRequest {
	return v.value
}

func (v *NullableDataStreamFilterRequest) Set(val *DataStreamFilterRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDataStreamFilterRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDataStreamFilterRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataStreamFilterRequest(val *DataStreamFilterRequest) *NullableDataStreamFilterRequest {
	return &NullableDataStreamFilterRequest{value: val, isSet: true}
}

func (v NullableDataStreamFilterRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataStreamFilterRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
