...
// AWSKinesisFirehoseEndpointAsEndpoint is a convenience function that returns AWSKinesisFirehoseEndpoint wrapped in Endpoint
func AWSKinesisFirehoseEndpointAsEndpoint(v *AWSKinesisFirehoseEndpoint) Endpoint {
	return Endpoint{
		AWSKinesisFirehoseEndpoint: v,
	}
}

// AzureBlobStorageEndpointAsEndpoint is a convenience function that returns AzureBlobStorageEndpoint wrapped in Endpoint
func AzureBlobStorageEndpointAsEndpoint(v *AzureBlobStorageEndpoint) Endpoint {
	return Endpoint{
		AzureBlobStorageEndpoint: v,
	}
}

// AzureMonitorEndpointAsEndpoint is a convenience function that returns AzureMonitorEndpoint wrapped in Endpoint
func AzureMonitorEndpointAsEndpoint(v *AzureMonitorEndpoint) Endpoint {
	return Endpoint{
		AzureMonitorEndpoint: v,
	}
}

// BigQueryEndpointAsEndpoint is a convenience function that returns BigQueryEndpoint wrapped in Endpoint
func BigQueryEndpointAsEndpoint(v *BigQueryEndpoint) Endpoint {
	return Endpoint{
		BigQueryEndpoint: v,
	}
}

// DatadogEndpointAsEndpoint is a convenience function that returns DatadogEndpoint wrapped in Endpoint
func DatadogEndpointAsEndpoint(v *DatadogEndpoint) Endpoint {
	return Endpoint{
		DatadogEndpoint: v,
	}
}

// ElasticsearchEndpointAsEndpoint is a convenience function that returns ElasticsearchEndpoint wrapped in Endpoint
func ElasticsearchEndpointAsEndpoint(v *ElasticsearchEndpoint) Endpoint {
	return Endpoint{
		ElasticsearchEndpoint: v,
	}
}

// HttpPostEndpointAsEndpoint is a convenience function that returns HttpPostEndpoint wrapped in Endpoint
func HttpPostEndpointAsEndpoint(v *HttpPostEndpoint) Endpoint {
	return Endpoint{
		HttpPostEndpoint: v,
	}
}

// KafkaEndpointAsEndpoint is a convenience function that returns KafkaEndpoint wrapped in Endpoint
func KafkaEndpointAsEndpoint(v *KafkaEndpoint) Endpoint {
	return Endpoint{
		KafkaEndpoint: v,
	}
}

// QRadarEndpointAsEndpoint is a convenience function that returns QRadarEndpoint wrapped in Endpoint
func QRadarEndpointAsEndpoint(v *QRadarEndpoint) Endpoint {
	return Endpoint{
		QRadarEndpoint: v,
	}
}

// S3EndpointAsEndpoint is a convenience function that returns S3Endpoint wrapped in Endpoint
func S3EndpointAsEndpoint(v *S3Endpoint) Endpoint {
	return Endpoint{
		S3Endpoint: v,
	}
}

// SplunkEndpointAsEndpoint is a convenience function that returns SplunkEndpoint wrapped in Endpoint
func SplunkEndpointAsEndpoint(v *SplunkEndpoint) Endpoint {
	return Endpoint{
		SplunkEndpoint: v,
	}
}
...
func (obj Endpoint) GetActualInstanceValue() (interface{}) {
	if obj.AWSKinesisFirehoseEndpoint != nil {
		return *obj.AWSKinesisFirehoseEndpoint
	}
