...
type PatchedResellerRequest struct {
	...
	CurrencyIsoCode *CurrencyIsoCodeEnum `json:"currency_iso_code,omitempty"`
...
// SetCurrencyIsoCode gets a reference to the given CurrencyIsoCodeEnum and assigns it to the CurrencyIsoCode field.
